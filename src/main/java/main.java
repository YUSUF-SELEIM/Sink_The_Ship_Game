...
public class main {
    ...
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        ...
        System.out.println("Cheats of First Ship "+newGame.firstShip);
        System.out.println("Cheats of Second Ship "+newGame.secondShip);
        System.out.println("Cheats of Third Ship "+newGame.thirdShip);
        ...
        while (true) {
            ...
            if (guessesCounter == 15 && (!newGame.firstShip.isEmpty() || !newGame.secondShip.isEmpty() || !newGame.thirdShip.isEmpty())) {
                ...
                System.out.println("Datum : We are Out Of Missiles Sir");
                System.out.println("General Seal : How did You Join The Navy You Idiot We Lost");
                System.out.println("You : it Was Datum Not me");
